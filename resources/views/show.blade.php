<x-app-layout>
   ...
   <div class="buttons-container flex items-center justify-between mt-6">
       <div class="flex items-center space-x-4 ml-6">
        <div class=" relative">
            <button type="button" class="flex w-32 items-center justify-center h-11 text-sm bg-blue
            ...
            <div class="absolute z-10 w-104 text-left font-semibold text-sm bg-white shadow-dialog rounded-xl mt-2">
                <form action="#" class="space-y-4 px-4 py-6">
                    ...
                    <div class="flex items-center space-x-3">
                        <button>
                            <button type="button" class="flex w-1/2 items-center justify-center h-11 text-sm bg-blue
                            font-semibold rounded-xl border text-white border-blue hover:bg-blue-hover transition duration-150 ease-in px-1 py-3 ">
                                Post comment
                        </button>
                        <button type="button" class="flex items-center justify-center w-32 h-11 text-xs bg-gray-200
            ...
            <div class="relative">
                <button type="button" class="flex items-center w-34 justify-center h-11 text-sm bg-gray-200
                                    font-semibold rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in px-6 py-3 ">
