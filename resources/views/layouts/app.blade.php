...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
       ...
       <main class="container mx-auto flex max-w-custom">
           <div class="w-70 mr-5">
                <div class="bg-white border-2 text-center border-blue rounded-xl mt-16"      style="
              ...
              ">
                    ...
                    <form action="#" method="POST" class=" space-y-4 px-4 py-6">
                        ...
                        <div>
                            <textarea name="idea" id="idea" cols="30" rows="4" class="w-full border-none bg-gray-100 rounded-xl placeholder-gray-700 text-sm px-4 py-2"
